...
const ACTIVE_PROJECT_NAMES = new Set(['Bowmanville GO Extension', 'Ballard Link Extension', 'West Phoenix High-Capacity Transit Corridor', 'Colorado Connector', 'Lackawanna Cut-Off Restoration', 'New River Valley Passenger Rail Project', 'Rio East–Dobson Streetcar Extension', 'Red Line Modernization Project', 'Green Line Transformation Program', 'Stone Avenue BRT', 'Eastside Transit Corridor Phase 2', 'Vermont Avenue BRT', 'Transbay Program Downtown Extension', 'Downtown Riverfront Streetcar', 'Federal Boulevard BRT', 'West Elizabeth Corridor', 'Broward Commuter Rail South', 'Northeast Corridor Rapid Transit', 'MARTA Rapid Campbellton', 'MARTA Rapid Southlake', 'Blue Hill Avenue Transit Action Plan', 'Cleveland MetroHealth Line BRT', 'Columbus East Main Street BRT', 'Columbus Northwest BRT', 'Columbus West Broad Street BRT', 'MAPS 4 Bus Rapid Transit Corridor', '82nd Avenue Transit Project', 'Montgomery Park Transit Project', 'TV Highway Transit and Safety Project', 'Lowcountry Rapid Transit', 'METRORapid Gulfton Corridor', 'San Antonio ART East/West Corridor', 'Davis-Salt Lake City Community Connector', 'FrontRunner 2X', 'Richmond Highway Bus Rapid Transit', 'Swift Gold Line BRT', 'RapidRide K Line BRT', 'Division Street Bus Rapid Transit', 'Madison North-South BRT', 'Tren México–Pachuca', 'Tren México–Querétaro', 'Tren Querétaro–Irapuato', 'Tren Saltillo–Nuevo Laredo', 'Tren Suburbano Lechería–AIFA', 'Alto High-Speed Rail', 'Honolulu Skyline Segment 3', 'Eglinton Crosstown LRT', 'Finch West LRT', 'Hazel McCallion Line', 'Hamilton B-Line LRT', 'Ontario Line', 'Scarborough Subway Extension', 'Yonge North Subway Extension', 'Durham-Scarborough BRT', 'Eglinton Crosstown West Extension', 'ION Stage 2', 'Eglinton East LRT', 'Sheppard East LRT', 'Waterfront West LRT', 'Waterfront East LRT', 'Hamilton A-Line', 'Finch West LRT Extension', 'Brampton Queen Street BRT / LRT', 'Downtown Mississauga Transitway', 'Bailey Avenue BRT', 'East London Link', 'Wellington Gateway', 'NFTA Metro Transit Expansion', 'O-Train Stage 2 West Extension', 'REM Anse-à-l’Orme Branch', 'Montréal Blue Line Extension', 'TramCité', 'Broadway Subway Extension', 'Green Line Phase 1', 'Green Line Phase 2', 'O-Train Stage 2 East Extension', 'O-Train Stage 2 South Extension', 'Surrey–Langley SkyTrain', 'REM South Shore', 'REM Deux-Montagnes Branch', 'Maryland Purple Line', 'Valley Line West LRT', 'Federal Way Link Extension', 'D Line Extension Section 1', 'D Line Extension Section 2', 'D Line Extension Section 3', 'METRO Green Line Extension', 'South Central Extension / Downtown Hub', 'REM Airport Branch', 'Lynnwood Link Extension', '2 Line East Link Extension', 'DART Silver Line', 'CTA Red Line Extension', 'South Coast Rail Fall River', 'South Coast Rail New Bedford', 'A Line Foothill Extension', 'East San Fernando Valley LRT', 'Capital Line South', 'Second Avenue Subway Phase 2', 'Penn Station Access', 'VTA BART Silicon Valley Phase II', 'NICTD West Lake Corridor', 'KC Streetcar Main Street Extension', 'KC Streetcar Riverfront Extension', 'MARTA Rapid A-Line', 'Gateway Hudson Tunnel Project', 'LAX SkyLink', 'Austin Light Rail Phase 1', 'Southeast Gateway Line', 'UTA Midvalley Express (MVX)', 'Maryland Parkway BRT', 'Interborough Express (IBX)', 'West Seattle Link Extension', 'Kitchener Extension', 'Gormley Extension', 'Lakeshore West Line - West Harbour Extension', 'Barrie Extension', 'Niagara Extension', 'Confederation Extension', 'Sepulveda Transit Corridor']);
...
async function fetchProjects() {
    ...
    try {
        const responses = await Promise.all([
            ...
            fetch('data/honolulu-projects.json'),
            fetch('data/fta-projects.json'),
            fetch('data/mexico-projects.json'),
            fetch('data/canada-projects.json'),
            fetch('data/news-projects.json')
        ]);
