...
async function fetchProjects() {
    try {
        const [response, supplementalResponse, nftaResponse, londonResponse, ottawaResponse, remResponse, montrealResponse, quebecResponse, vancouverResponse, marylandResponse, edmontonResponse, seattleResponse, laResponse] = await Promise.all([
        ...
        const features = [...data.features, ...supplemental.features, ...nfta.features, ...london.features, ...ottawa.features, ...rem.features, ...montreal.features, ...quebec.features, ...vancouver.features, ...maryland.features, ...edmonton.features, ...seattle.features, ...la.features];
