...
async function fetchProjects() {
    try {
        const [response, supplementalResponse, nftaResponse, londonResponse] = await Promise.all([
        ...
        const features = [...data.features, ...supplemental.features, ...nfta.features, ...london.features];
