...
async function fetchProjects() {
    try {
        const [
            ...
            indianaResponse, kansasCityResponse, atlantaResponse
        ] = await Promise.all([
