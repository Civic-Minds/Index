...
async function fetchProjects() {
    try {
        const [response, supplementalResponse, nftaResponse, londonResponse, ottawaResponse, remResponse, montrealResponse] = await Promise.all([
        ...
        const features = [...data.features, ...supplemental.features, ...nfta.features, ...london.features, ...ottawa.features, ...rem.features, ...montreal.features];
